...
\input{Kapitel/titlepage.tex}                                                   % Einbinden der Titelseite
...
\input{Kapitel/abbreviations.tex}
\clearpage

\pagenumbering{arabic}                                                  % Seitenzahlen in arabischen Zahlen


\input{Kapitel/Einleitung}                                                      % Einbindung der Einleitung
\clearpage
\input{Kapitel/Hauptteil}                                                       % Einbindung des Hauptteils
\clearpage
\input{Kapitel/Schluss}                                                         % Einbindung des Schlussteils
